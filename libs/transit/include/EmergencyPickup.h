...
/**
 * @brief Returns the current position of the emergency pickup drone as a Vector3 object
 * 
...
/**
 * @brief Returns the current direction of the emergency pickup drone as a Vector3 object
 * 
...
/**
 * @brief Returns the current destination of the emergency pickup drone as a Vector3 Object
 * 
