...
class RechargeStation : public IEntity{
    ...
    /**
     * @brief Returns the current position of the recharge station as a Vector3 object
     *
    ...
    /**
     * @brief Returns the current direction of the recharge station as a Vector3 object
     * 
     ...
     **/
     ...
     /**
     * @brief Returns the current destination of the recharge station as a Vector3 object
     * 
    ...
    /**
     * @brief Returns the current availability of the recharge station as a boolean value
     * 
