...
/**
  ...
  * 
  * @return direction, a Vector3 representing the current direction of the robot
  **/
...
/**
  ...
  * 
  * @return destination, a Vector3 representing the current destination of the robot
  **/
...
/**
  ...
  * 
  * @param strategyName_, a string representing the intended strategy name for the Robot to use
  * @return None
  **/
